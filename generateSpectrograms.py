...
print(f"wavFileList:{wavFileList}")
...
for fooTrack in outputParts:
    ...
    barColor = settings_yaml['Tracks'][fooTrack]['VID_HSB']
    backColor = [100, 0, 0]
    specAnimate.generateAnimation(wavFileName, outputFileName, settings_yaml['Tracks'][fooTrack], videoDims=videoDimensions, framesPerSecond=30, bar_color=barColor, back_color=backColor)
